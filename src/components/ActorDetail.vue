...
<div>
  <v-container>
    <v-row>
            ...
            <v-card-text>
              <v-row class="mx-0 d-flex justify-center">
                <v-btn
                  ...
                  dark
                  small
                  style="background: rgb(3, 37, 65); color: white;"
      ...
      <v-col cols="12" sm="8">
        ...
        <v-row>
          <v-col cols="12">
            <v-btn text >
              <v-icon color="rgb(3, 37, 65)">fas fa-birthday-cake</v-icon>
            </v-btn>
        ...
        <h4 class="mt-1 grey--text">Principais Filmes</h4>
        <v-row>
    ...
    <v-divider class="mt-2"></v-divider>  
      <h2 class="mt-2 grey--text ">Filmes</h2>
      <ul class=" pl-5 mt-8">
